    ...
    <el-card shadow="never" class="aui-card--fill">
        <div class="mod__repair">
            <el-form :inline="true" :model="query" @keyup.enter.native="getData()">
                ...
                <el-form-item>
                    <el-button :disabled="this.multipleSelection.length === 0" type="danger"
                               @click="delBatchRepairInfo">批量删除
                    </el-button>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" @click="addRepairInfo">添加</el-button>
                </el-form-item>
            </el-form>
            <el-table v-loading="tableDataLoading" :data="tableData" border @selection-change="selectionChange"
                ...
                <el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
                    <template slot-scope="scope">
                        ...
                        <el-button type="danger" size="small" @click="delRepairInfo(scope.row.id)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
            ...
            <!-- 弹窗, 新增 / 修改 -->
            <el-dialog :visible.sync="addOrUpdateVisible" :title="!form.id ? '新增' : '编辑'"
                       :close-on-click-modal="false" :close-on-press-escape="false">
                <el-form :model="form" :rules="rule" ref="form" label-width="100px">
<!--                    <el-form-item label="报修人" prop="">-->
<!--                        <el-input v-model="form.userId" placeholder="报修人"></el-input>-->
<!--                    </el-form-item>-->

                    <el-form-item label="报修人" prop="userId">
                        <el-select v-model="form.userId" placeholder="请选择报修人">
                            <el-option
...
export default {
    ...
    data() {
        return {
            ...
            rule: {
                markperson: [{ required: true, message: '报修人不得为空', trigger: 'blur' }],
                labconf: [{ required: true, message: '实验室名不得为空', trigger: 'blur' }],
                ...
                repairRemark: [{ required: false, message: '报修说明不得为空', trigger: 'blur' }]
            }
        };
    },
    created() {
