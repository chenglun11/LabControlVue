...
<!--        </el-form-item>-->
      ...
      <el-table-column prop="imageUrl" label="图片"  header-align="center" align="center">
       ...
       <el-table-column prop="updateTime" label="更新时间" width="160" header-align="center" align="center"></el-table-column>
            ...
            <template slot-scope="scope">
                    <el-button type="success"  size="small"  @click="updateAppointInfo(scope.row)">审核</el-button>
                    <el-button type="danger"  size="small"  @click="delAppointInfo(scope.row.id)">删除</el-button>
            </template>
        </el-table-column>
     </el-table>
      <el-pagination
