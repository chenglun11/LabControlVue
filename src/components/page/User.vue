    ...
    <el-card shadow="never" class="aui-card--fill">
        <div class="mod__user">
            <el-form :inline="true" :model="query" @keyup.enter.native="getData()">
                ...
                <el-form-item>
                    <el-button :disabled="this.multipleSelection.length === 0" type="danger" @click="delBatchUserInfo">
                        批量删除
                    </el-button>
                </el-form-item>
            ...
            <el-dialog :visible.sync="addOrUpdateVisible2" title="修改密码" :close-on-click-modal="false"
