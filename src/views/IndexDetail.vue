<template>
    <div>
        ...
        <el-dialog :visible.sync="addOrUpdateVisible" title="预约" :close-on-click-modal="false"
        ...
        <el-dialog :visible.sync="addOrUpdateVisible2" title="报修" :close-on-click-modal="false"
                   :close-on-press-escape="false">
            <el-form :model="form" :rules="rule" ref="form" label-width="100px">
